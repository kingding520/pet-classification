...
inline const Format (&EnumValuesFormat())[19] {
...
inline const char *EnumNameFormat(Format e) {
  if (flatbuffers::IsOutRange(e, Format_NCHW, Format_NC8HW8)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum ActivationType : int8_t {
  ...
  ActivationType_FAST_GELU = 20,
  ActivationType_UNKNOWN = 21,
  ActivationType_MIN = ActivationType_NO_ACTIVATION,
  ActivationType_MAX = ActivationType_UNKNOWN
};

inline const ActivationType (&EnumValuesActivationType())[22] {
