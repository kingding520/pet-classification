...
def train_parse_args():
    ...
    train_parser.add_argument('--network', type=str, default='mobilenetv2', choices=('mobilenetv2', 'shufflenetv2'),
                              help='Backbone network name used for fine-tuning')
    ...
    train_parser.add_argument('--dataset_path', type=str, default="dataset\PetImages", help='Dataset path')
